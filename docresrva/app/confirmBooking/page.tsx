        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {patient && (
            <div className="bg-white shadow-lg rounded-lg p-4 flex flex-col items-center">
              ...
              <p className="text-gray-600"><strong>Name:</strong> {patient.firstName} {patient.lastName}</p>
              <p className="text-gray-600"><strong>Age:</strong> {patient.age}</p>
              <p className="text-gray-600"><strong>Gender:</strong> {patient.gender}</p>
              <p className="text-gray-600"><strong>Reason:</strong> {patient.reason}</p>
              <button
                className="mt-4 bg-teal-600 text-white px-6 py-2 rounded-lg shadow hover:bg-teal-700 transition-all"
